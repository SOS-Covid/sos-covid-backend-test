...
//
//    @Test(dataProvider = "Complete", dataProviderClass = ContribuidorDataProvider.class,
//            groups = {"funcional"})
...
//            groups = {"funcional"})
//    public static void cadastrarContribuidorOptionalFields(ContribuidorConstructor contribuidor) {
//
//        given().
//                contentType(ContentType.JSON).
//                body(contribuidor).
